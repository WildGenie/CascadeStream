...
// Type: CascadeFlowClient.Messages
...
namespace CascadeFlowClient
{
  public class Messages : ILocalizationProvider
  {
    ...
    public static string SelectNonCategoryRecordToAdd
    {
      get
      {
        return Messages.Manager.GetString("SelectNonCategoryRecordToAdd");
      }
    }

    public static string CapturedFrame
    {
      get
      {
        return Messages.Manager.GetString("CapturedFrame");
      }
    }

    public static string PhotoFromDataBase
    {
      get
      {
        return Messages.Manager.GetString("PhotoFromDataBase");
      }
    }
    ...
    public static string AllDevices
    {
      get
      {
        return Messages.Manager.GetString("AllDevices");
      }
    }

    public static string AllViewDevices
    {
      get
      {
        return Messages.Manager.GetString("AllViewDevices");
      }
    }

    public static string DatabaseServerAvailable
    {
      get
      {
        return Messages.Manager.GetString("DatabaseServerAvailable");
      }
    }

    public static string DatabaseServerUnavailable
    {
      get
      {
        return Messages.Manager.GetString("DatabaseServerUnavailable");
      }
    }
    ...
    public static string PeopleCount
    {
      get
      {
        return Messages.Manager.GetString("PeopleCount");
      }
    }
