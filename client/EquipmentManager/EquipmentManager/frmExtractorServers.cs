...
// Type: CascadeEquipment.FrmExtractorServers
...
{
  public class FrmExtractorServers : XtraForm
  {
    private DataTable _dtMain = new DataTable();
    public bool ListFlag = false;
    public BcExtractorServer MainServer = new BcExtractorServer();
    ...
    public void CheckServices()
    {
      while (!FrmDevices.ClosFlag)
      {
        try
        {
          ...
          while (!FrmDevices.ClosFlag)
          {
            this.Invoke((Delegate) new FrmExtractorServers.RefreshStateFunc(this.RefreshState), (object) managmentServerClient.GetExtractorServerState());
            Thread.Sleep(5000);
          }
          try
          {
    ...
    private void frmExtractorServers_Load(object sender, EventArgs e)
    {
      ...
      this.ReloadGrid();
      this.tbNumber.EditValue = (object) (BcExtractorServer.LoadMaxNumber() + 1);
      this.tbPort.EditValue = (object) BcExtractorServer.LoadMaxPort();
    }
    ...
    private void btAdd_ItemClick(object sender, ItemClickEventArgs e)
    {
      ...
      this._dtMain.Rows.Add((object) Guid.Empty, (object) num1, (object) (Messages.ExtractorServer + (object) num1), (object) "", (object) "0.0.0.0", (object) num2, (object) DateTime.Now, (object) DateTime.Now, (object) Messages.Unavailable, (object) true);
    }
    ...
    private void btSave_ItemClick(object sender, ItemClickEventArgs e)
    {
      ...
      foreach (DataRow dataRow in (InternalDataCollectionBase) this._dtMain.Rows)
      {
        ...
        {
          BcExtractorServer bcExtractorServer = new BcExtractorServer();
          bcExtractorServer.Id = (Guid) dataRow["ID"];
          bcExtractorServer.Ip = dataRow["IP"].ToString();
          bcExtractorServer.Port = (int) dataRow["Port"];
          bcExtractorServer.Name = dataRow["Name"].ToString();
          bcExtractorServer.Comment = dataRow["Comment"].ToString();
          bcExtractorServer.Number = (int) dataRow["Number"];
          bcExtractorServer.Save();
          dataRow["ID"] = (object) bcExtractorServer.Id;
    ...
    private void btAccept_Click(object sender, EventArgs e)
    {
      ...
      this.MainServer = new BcExtractorServer();
    ...
    private void frmExtractorServers_FormClosing(object sender, FormClosingEventArgs e)
    {
      try
      {
    ...
    {
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (FrmExtractorServers));
      ...
      this.Name = "FrmExtractorServers";
      this.FormClosing += new FormClosingEventHandler(this.frmExtractorServers_FormClosing);
      this.Load += new EventHandler(this.frmExtractorServers_Load);
