...
typedef IFacePoseChanger* (__cdecl *TypeOf_CreateFacePoseChanger) (const int nOutputWidth, const int nOutputHeight);
extern TypeOf_CreateFacePoseChanger CreateFacePoseChanger;
